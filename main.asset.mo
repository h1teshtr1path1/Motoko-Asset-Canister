...
// actor class Assets(owner : Principal) : async AssetStorage.Self = {
actor Assets {
    var owner : Principal = Principal.fromText("2ot7t-idkzt-murdg-in2md-bmj2w-urej7-ft6wa-i4bd3-zglmv-pf42b-zqe");
    ...
    //utility functions
    //
    public func commit_asset_upload(batchId : AssetStorage.BatchId, _key : AssetStorage.Key, _type : Text, chunkIds : [AssetStorage.ChunkId]) : async (Result.Result<(), Text>) {
